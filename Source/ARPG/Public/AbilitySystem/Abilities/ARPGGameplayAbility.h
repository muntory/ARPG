...
protected:
	...
	UARPGPawnCombatComponent* GetPawnCombatComponentFromActorInfo() const;
	...
	UFUNCTION(BlueprintCallable, Category = "ARPG|Ability", meta = (DisplayName = "Apply Gameplay Effect Spec Handle To Target Actor", ExpandEnumAsExecs = "OutSuccessType"))
	FActiveGameplayEffectHandle BP_ApplyEffectSpecHandleToTarget(AActor* TargetActor, const FGameplayEffectSpecHandle& InSpecHandle, EARPGSuccessType& OutSuccessType);
};
